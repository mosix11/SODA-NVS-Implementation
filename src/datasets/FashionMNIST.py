...
class FashionMNIST():
    ...
    def __init__(self,
        ...
        transformations = [
            ...
            v2.Normalize((0.2860,), (0.3530,)) # Values Specific to Fashion MNIST
        ]
    ...
    def _init_loaders(self):
        train_dataset = datasets.FashionMNIST(root=self.dataset_dir, train=True, transform=self.transformations, download=True)
        test_dataset = datasets.FashionMNIST(root=self.dataset_dir, train=False, transform=self.transformations, download=True)
